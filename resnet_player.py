...
from resnet import ResNetGomoku
...
class Player:
    ...
    def __init__(
        ...
        # se não passares model_path, usa 'gomoku_resnet.pt' ou 'pente_resnet.pt'
        if model_path is None:
            model_path = f"{self.rules}_resnet.pt"

        self.net = ResNetGomoku(board_size=board_size, in_channels=3).to(self.device)
        self.net.eval()
